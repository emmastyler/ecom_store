      ...
      >
        <div className="container">
          ...
          <ul className="buy-button list-inline mb-0 ">
            <li className="list-inline-item mb-0 me-1 p-2">
            ...
            <li className="list-inline-item mb-0 me-1">
              {becomeUrl ? (
                <a
                  ...
                  style={{postion:'absolute', marginLeft:'.3rem', marginRight:'.9rem'}}
                >
                  <i className="uil uil-shopping-cart fs-4" style={{color:'black'}}></i>
                  <span style={{position:'relative', fontSize:'0.8rem', right:'3px', top:'-8px', width:'20px', height:'20px', marginRight:'-0.8rem', borderRadius:'50%'}} className="btn-primary">{cartTotalQuantity}</span>
                </a>
              ) : (
                <p id="connectWallet" onClick={_handleConnectWallet}>
                  <span className="btn-icon-dark">
                    <span className="btn btn-icon btn-pills btn-primary">
                      <i className="uil uil-shopping-cart fs-12"></i>
                    </span>
                  </span>
