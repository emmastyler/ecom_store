...
import { client01, client02, client03, client08, client09, client10, item1, item2, gif1, gif2, itemDetail1, oldNaira, newNaira, deltime} from '../../components/imageImport'
        ...
        <div className="container">
          ...
          {product?.map(data => {
            ...
            <div className="col-md-6">
              ...
              <iframe className='mt-4 rounded-md shadow' width="100%" height="330" src={data.videoUrl}
              ...
              <div className="ms-lg-5">
                ...
                <div className="row">
                  <div className="col-md-6 mt-4 pt-2">
                    <h6>Current Price</h6>
                    <h4 className="mb-0">
                    <img src={oldNaira} alt="newnaira" style={{width: '1rem', marginBottom: '.2rem'}}/>
                      {data.currentPrice.toLocaleString("en-US")}
                      </h4>
                    <small className="mb-0 text-muted" style={{textDecoration: 'line-through'}}><img src={newNaira} alt="oldnaira" style={{width: '1rem', marginBottom: '.2rem'}}/> {data.oldPrice.toLocaleString("en-US")}</small>
                  </div>

                  <div className="col-md-6 mt-4 pt-2">
                    <h6 className="" style={{}}>Delivery Time</h6><hr style={{marginTop:'-.4rem'}}/><img src={deltime} alt="" style={{width: '3rem', paddingRight:' -3rem'}} />
                    {/* <Countdown
                  ...
                  <div className="col-12 mt-4 pt-2">
                    ...
                    >
                      <i className="mdi mdi-gavel fs-5 me-2"></i> Visit Store
                    </a>
                    <button
