...
import {
  ...
  gif1, gif2, gif3, gif4, gif5, gif6,cta,
  c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12,
  work1, work2, work3, work4, work5, work6, work7, work8, work9, work10, work11, work12, oldNaira, newNaira, saveNaira,
        ...
        <div className="container mt-4 pt-2 mt-lg-0 pt-lg-0">
          <div className="row row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 g-4">
            {data?.data.map(products => {
              return (
                <div className="col" key={products?.name}>
                  <div className="card nft-items nft-primary rounded-md shadow overflow-hidden mb-1 p-3">
                    <div className="d-flex justify-content-between">
                      <div className="img-group">
                        ...
                        >
                          <img
                            src={'http://localhost:3000/'+ products.imageUrl}
                            alt="user"
                    ...
                    <div className="nft-image rounded-md mt-3 position-relative overflow-hidden">
                      ...
                      >
                        <img src={'http://localhost:3000/'+ products?.imageUrl} className="img-fluid" alt=""/>
                      </a>
                      <div className="position-absolute top-0 start-0 m-2">
                        ...
                        >
                         -{Math.round(100 - (products.currentPrice / (products.oldPrice/100)))}%
                        </a>
                      </div>
                      <div className={`${products?.id ? '' : 'hide-data'} position-absolute bottom-0 start-0 m-2 bg-gradient-primary text-white title-dark rounded-pill px-3`}>
                        <i className="uil uil-rating"></i>{' '}
                        <Countdown
                          date={products?.id}
                    ...
                    <div className="card-body content position-relative p-0 mt-3">
                      ...
                      >
                        {products?.name.length > 20 ? products?.name.substring(0, 20).concat('...') : products?.name}
                      </a>

                      <div className="d-flex justify-content-between mt-2">
                        <div style={{fontWeight: 'bold'}}><img src={oldNaira} alt="newnaira" style={{width: '1rem', marginBottom: '.2rem'}}/>{products.currentPrice.toLocaleString("en-US")} <small className="rate fw-bold" style={{textDecoration: 'line-through', opacity: '0.4'}}><img src={newNaira} alt="oldnaira" style={{width: '1rem', marginBottom: '.2rem'}}/>{products.oldPrice.toLocaleString("en-US")}</small></div>
                      ...
                      <div className="d-flex justify-content-between mt-2" >
                        <small className="rate fw-bold "   
                          ref={el => {
                            if (el) {
                              ...
                              el.style.setProperty('font-size', '.65rem');
                              el.style.setProperty('margin-top', '-.3rem');
                            }
                          }}>
                        <img src={saveNaira} alt="savenaira" style={{width: '1rem', marginBottom: '.2rem'}}/>{Math.round((100 - (products.currentPrice / (products.oldPrice/100))) / 100 * products.oldPrice).toLocaleString("en-US")} saved
                        </small>
                        {/*<div style={{}}></div>*/}
                        <div className="" style={{ position: 'relative'}}>
                              <a
                                href=""
                                onClick={e => e.preventDefault()}
                                className=" btn-soft-primary pb-2 p-1" style={{borderRadius: '.5rem'}}
                              >
                                <small style={{fontSize: '.5rem', fontWeight:'bold'}}>ADD TO CART</small>
                              </a>
                              <div style={{backgroundColor: '#0F66E7', width: '25px', height: '25px', borderRadius: '50%', position:'absolute', right:'21px', top:'-14px'}}>
                              <i className="uil uil-shopping-cart fs-12" style={{color: 'white', paddingLeft: '.3rem'}}></i> 
