...
import {useRegisterUserMutation} from '../../features/productApi';
...
const SignUp = () => {
  ...
  const [userInfo, {error, status, data}] = useRegisterUserMutation()

  const handleSubmit = (e) => {
    e.preventDefault()
    userInfo({fullName, email, phone, password})
